...
Route::prefix('finance')->name('finance.')->group(function () {
    ...
    Route::prefix('cash-loan')->name('cash_loan.')->group(function () {
        ...
        Route::get('/tenure',            [\App\Http\Controllers\Finance\FinanceWebController::class, 'cashLoanAmountTenure'])->name('s05_tenure');
        ...
        Route::get('/partner-select',    [\App\Http\Controllers\Finance\FinanceWebController::class, 'cashLoanPartnerRedirect'])->name('s13_partner_select');
        ...
        Route::get('/processing',        [\App\Http\Controllers\Finance\FinanceWebController::class, 'cashLoanProcessingWindow'])->name('s20_processing');
    ...
    Route::prefix('business-loan')->name('business_loan.')->group(function () {
        ...
        Route::get('/tenure',            [\App\Http\Controllers\Finance\FinanceWebController::class, 'businessLoanAmountTenure'])->name('s05_tenure');
        ...
        Route::get('/ready',             [\App\Http\Controllers\Finance\FinanceWebController::class, 'businessLoanReadyProcessing'])->name('s09_ready');
        ...
        Route::get('/app-generated',     [\App\Http\Controllers\Finance\FinanceWebController::class, 'businessLoanApplicationGen'])->name('s11_app_generated');
