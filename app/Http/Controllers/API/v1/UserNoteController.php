...
class UserNoteController extends Controller
{
  ...
  public function register(Request $request)
  {
      ...
      if ($chknote->count() > 0){
                ...
                $updatedata = DB::update('update tj_user_note set niveau_driver = ?,modifier = ?,comment = ? where id_conducteur = ? AND ride_id = ? AND id_user_app = ?',[$note_value,$date_heure,$comment,$id_conducteur,$ride_id,$id_user_app]);
