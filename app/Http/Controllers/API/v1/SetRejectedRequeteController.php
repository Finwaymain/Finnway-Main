...

{
...

    {
        ...
        // For user_app cancellations during "searching" phase, id_user (driver) may be 0/null — that is fine.
        if (!empty($id_requete) && !empty($from_id) && !empty($driver_name) && (!empty($id_user) || $user_cat == 'user_app')) {
