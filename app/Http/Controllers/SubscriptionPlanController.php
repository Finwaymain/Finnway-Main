...
class SubscriptionPlanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        SubscriptionPlan::create([
            ...
            'sender_cashback_value'      => $data['sender_cashback_value'] ?? 0,
            'receiver_cashback_type'     => $data['receiver_cashback_type'] ?? 'percentage',
            'receiver_cashback_value'    => $data['receiver_cashback_value'] ?? 0,
            'discount_home_service'      => $data['discount_home_service'] ?? 0,
            'discount_travel'            => $data['discount_travel'] ?? 0,
            'discount_hotel'             => $data['discount_hotel'] ?? 0,
            'discount_food'              => $data['discount_food'] ?? 0,
            'discount_medical'           => $data['discount_medical'] ?? 0,
            'discount_marketplace'       => $data['discount_marketplace'] ?? 0,
            'discount_transaction'       => $data['discount_transaction'] ?? 0,
            'min_amount_hotel'          => $data['min_amount_hotel'] ?? 0,
            'min_amount_home_service'   => $data['min_amount_home_service'] ?? 0,
            'min_amount_shopping'       => $data['min_amount_shopping'] ?? 0,
            'min_amount_food'           => $data['min_amount_food'] ?? 0,
            'min_amount_travel'         => $data['min_amount_travel'] ?? 0,
            'min_amount_medical'        => $data['min_amount_medical'] ?? 0,
            'min_amount_cab'            => $data['min_amount_cab'] ?? 0,
            'discount_delivery_food'         => $data['discount_delivery_food'] ?? 0,
            'discount_delivery_shopping'     => $data['discount_delivery_shopping'] ?? 0,
            'discount_delivery_home_service' => $data['discount_delivery_home_service'] ?? 0,
            'discount_delivery_medical'      => $data['discount_delivery_medical'] ?? 0,
            'discount_delivery_parcel'       => $data['discount_delivery_parcel'] ?? 0,
            'shopping_discount'          => $data['shopping_discount'] ?? 0,
            'free_ride_limit'            => $data['free_ride_limit'] ?? 0,
            'free_ride_reset'            => $data['free_ride_reset'] ?? 'monthly',
            'wallet_increment_value'     => $data['wallet_increment_value'] ?? 0,
            'wallet_increment_period'    => $data['wallet_increment_period'] ?? 'daily',
            'wallet_decrement_value'     => $data['wallet_decrement_value'] ?? 0,
            'wallet_decrement_period'    => $data['wallet_decrement_period'] ?? 'daily',
            'referral_bonus_type'        => $data['referral_bonus_type'] ?? 'flat',
            'referral_bonus_value'       => $data['referral_bonus_value'] ?? 0,
            'loan_enabled'               => $request->has('loan_enabled'),
            'loan_max_amount'            => $data['loan_max_amount'] ?? 0,
            'interest_free_loan_enabled' => $request->has('interest_free_loan_enabled'),
            'interest_free_loan_limit'   => $data['interest_free_loan_limit'] ?? 0,
        ]);
