...
class VehicleTypeRentalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasfile('image')) {
            ...
            if (!file_exists(public_path('assets/images/type_vehicle_rental/'))) {
                mkdir(public_path('assets/images/type_vehicle_rental/'), 0777, true);
            }
        ...
        if ($id != "") {
            ...
            if (is_array($id)) {
                ...
                for ($i = 0; $i < count($id); $i++) {
                    ...
                    $destination = public_path('assets/images/type_vehicle_rental/' . $user->image);
                    if (File::exists($destination)) {
                        File::delete($destination);
                    }
