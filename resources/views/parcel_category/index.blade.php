                        ...
                        <div class="card-body">
                            ...
                            <div class="userlist-topsearch d-flex mb-3">
                                <div class="userlist-top-left">
                                    <a class="nav-link " href="{{ route('parcel-category.create')}}"><i
                                    ...
                                    @if(count($parcel_category) > 0)
                                        @foreach($parcel_category as $value)
                                            <tr>
                                                ...
                                                <td class="action-btn">
                                                    <a href="{{route('parcel-category.edit', ['id' => $value->id])}}"><i class="fa fa-edit"></i></a>
                                                    <a href="{{route('parcel-category.delete', ['id' => $value->id])}}" class="delete-btn"><i
