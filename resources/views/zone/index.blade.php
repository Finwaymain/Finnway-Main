                        ...
                        <div class="card-body">
                            ...
                            <div class="userlist-topsearch d-flex mb-3">
                                <div class="userlist-top-left">
                                    <a class="nav-link do_not_create" href="{{ route('zone.create') }}"><i class="fa fa-plus mr-2"></i>{{ trans('lang.create_zone') }}</a>
                                </div>
                                        ...
                                        @if (count($zones) > 0)
                                            @foreach ($zones as $zone)
                                                <tr>
                                                    ...
                                                    <td class="action-btn"><a href="{{ route('zone.edit', ['id' => $zone->id]) }}"  class="do_not_edit"><i class="fa fa-edit"></i></a>
                                                        <a href="{{ route('zone.delete', ['id' => $zone->id]) }}" class="delete-btn"><i class="fa fa-trash"></i></a>
