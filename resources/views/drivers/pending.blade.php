            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex top-title-section pb-4 justify-content-between">
                        ...
                        <form action="{{ route('drivers.pending') }}" method="get" id="filterForm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="dropdown text-right">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                                <li><a class="dropdown-item" href="{{ route('export.data', ['type' => 'excel', 'model' => 'Driver', 'is_verified' => '0']) }}">{{ trans("lang.export_excel") }}</a></li>
                                <li><a class="dropdown-item" href="{{ route('export.data', ['type' => 'pdf', 'model' => 'Driver', 'is_verified' => '0']) }}">{{ trans("lang.export_pdf") }}</a></li>
                                <li><a class="dropdown-item" href="{{ route('export.data', ['type' => 'csv', 'model' => 'Driver', 'is_verified' => '0']) }}">{{ trans("lang.export_csv") }}</a></li>
                            </ul>
                        </div>
                                ...
                                <tbody id="append_list12">
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-btn">
                                            ...
                                            <a href="{{route('drivers.edit', ['id' => $driver->id])}}"><i class="fa fa-edit"></i></a><a id="'+val.id+'" class="delete-btn" href="{{route('driver.delete', ['id' => $driver->id])}}"><i class="fa fa-trash"></i></a>
