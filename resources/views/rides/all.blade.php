      ...
      <div class="row">
        <div class="col-12">
          <div class="d-flex top-title-section pb-4 justify-content-between">
            ...
            <form action="{{ route('rides.all') }}" method="get" id="filterForm">
          ...
          <div class="card-body">
            ...
            <div class="dropdown text-right">
              ...
              <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                <li><a class="dropdown-item" href="{{ route('export.data', ['type' => 'excel', 'model' => 'Rides']) }}">{{ trans("lang.export_excel") }}</a></li>
                <li><a class="dropdown-item" href="{{ route('export.data', ['type' => 'pdf', 'model' => 'Rides']) }}">{{ trans("lang.export_pdf") }}</a></li>
                <li><a class="dropdown-item" href="{{ route('export.data', ['type' => 'csv', 'model' => 'Rides']) }}">{{ trans("lang.export_csv") }}</a></li>
              </ul>
            </div>
...
<script type="text/javascript">
  ...
  $("#deleteAll").click(function() {
    ...
    if ($('#example24 .is_open:checked').length) {
      ...
      alert('lang.select_delete_alert');
