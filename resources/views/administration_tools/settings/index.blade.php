...
<div class="page-wrapper">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('settings.update', ['id' => 1])}}" method="post"
                            ...
                            <div class="row restaurant_payout_create">
                                <div class="restaurant_payout_create-inner">
                                    ...
                                    <fieldset>
                                     ...
                                     <fieldset>
                                         <legend>VoiceFortius OTP Settings</legend>
                                         <div class="form-group row width-100">
                                             <label class="col-3 control-label">VoiceFortius OTP Service</label>
                                             <div class="col-7">
                                                 <select name="voice_fortius_otp_status" id="voice_fortius_otp_status" class="form-control">
                                                     <option value="1" {{ ($setting->voice_fortius_otp_status ?? '0') == '1' ? 'selected' : '' }}>ON (Send Live Voice OTP via VoiceFortius)</option>
                                                     <option value="0" {{ ($setting->voice_fortius_otp_status ?? '0') != '1' ? 'selected' : '' }}>OFF (Disable - Use Default 1234)</option>
                                                 </select>
                                                 <small class="form-text text-muted">When OFF, default OTP '1234' is used for instant verification without calling VoiceFortius API.</small>
                                             </div>
                                         </div>
                                     </fieldset>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="parcel_setting">
                                            ...
                                            <div class="form-group row width-100">
                                                ...
                                                <div class="col-7">
                                                    <input type="number" step="any" class="form-control parcel_per_weight_charge"
                                            ...
                                            <div class="form-group row width-100">
                                                <label
                                                    class="col-3 control-label">{{trans('lang.parcel_per_height_charge')}}</label>
                                                <div class="col-7">
                                                    <input type="number" step="any" class="form-control parcel_per_height_charge"
                                                        name="parcel_per_height_charge" id="parcel_per_height_charge"
                                                        value="{{$setting->parcel_per_height_charge}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row width-100">
                                            ...
                                            <div class="col-7">
                                                <select name="map_for_app" id="map_for_app"
                                                    ...
                                                    <option value="Google" {{($setting->map_for_application == "Google") ?
                                        "selected" : ""}}>{{trans("lang.google_maps")}}</option>
                                                    <option value="OSM" {{ ($setting->map_for_application == "OSM" ?
                                    ...
                                    <fieldset>
                                        <div class="form-group width-100 choose-theme">
                                            <label class="col-12 control-label">{{trans('lang.home_screen_type')}}</label>
                                            <div class="col-12">
                                                <div class="select-theme-radio">
                                                    <label class="form-check-label" for="app_homepage_theme_1">
                                                        <input type="radio" class="btn-check" name="home_screen_type" id="app_homepage_theme_1"
                                                            {{$setting->home_screen_type == 'OlaHome' ? 'checked' : ''}} value="OlaHome">
                                                        <p class="text-muted">{{trans("lang.ola_home")}}</p>
                                                    ...
                                                    <label class="form-check-label" for="app_homepage_theme_2">
                                                        ...
                                                        <input type="radio" class="btn-check" name="home_screen_type" id="app_homepage_theme_2"
                                                            value="UberHome" {{$setting->home_screen_type == 'UberHome' ? 'checked' : ''}}>
                                                        <p class="text-muted">{{trans("lang.uber_home")}}</p>
                                    ...
                                    {{--<fieldset>
                                                                         <legend>{{trans('lang.home_screen_type')}}</legend>
                                    <div class="form-group row width-50">
                                        <label class="col-3 control-label">{{trans('lang.home_screen_type')}}</label>
                                        <div class="col-7">
                                            <select type="text" class="form-control home_screen_type"
                                                name="home_screen_type" id="home_screen_type">
                                                <option value="OlaHome" {{$setting->home_screen_type == 'OlaHome' ? 'selected' : ''}}>{{trans("lang.ola_home")}}</option>
                                                <option value="UberHome" {{$setting->home_screen_type == 'UberHome' ? 'selected' : ''}}>{{trans("lang.uber_home")}}</option>
                                    ...
                                    <fieldset>
                                        ...
                                        <legend><i
                                                class="mr-3 mdi mdi-comment-alert"></i>{{trans('lang.notification_setting')}}
                                        </legend>
                                        ...
                                        <div class="form-group row width-100">
                                            <label
                                                class="col-3 control-label">{{trans('lang.upload_json_file')}}</label>
                                            <input type="file" name="serviceJson" class="col-7 pb-2">
                                            @if(! empty($setting->serviceJson) &&
                            ...
                            <div class="form-group col-12 text-center btm-btn">
                                ...
                                <button type="submit" class="btn btn-primary  edit-setting-btn"><i
    ...
    <div class="modal fade" id="themeModal" tabindex="-1" role="dialog" aria-labelledby="themeModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog" role="document" style="max-width: 665px;">
    ...
    <script>
        ...
        $(".form-group input[name='home_screen_type']").click(function() {
            if ($(this).is(':checked')) {
