    ...
    <div class="container-fluid pt-3">
        ...
        <form action="{{ route('subscription-plans.store') }}" method="POST" enctype="multipart/form-data">
            ...
            @php
                ...
                $oldFreeOrders = old('category_free_orders', []);
            @endphp
            ...
            <div class="section-card">
                ...
                <div class="section-body">
                    ...
                    <div class="d-flex flex-wrap align-items-center mb-4" id="categoryPillContainer">
                        ...
                        @php
                            $isSelected = ($oldCategories === null) ? true : in_array($cat, (array)$oldCategories);
                        @endphp
                            ...
                            <div class="col-md-6 col-lg-4 mb-2 category-free-order-item" id="free_order_item_{{ Str::slug($cat) }}" style="{{ $isSelected ? '' : 'display:none;' }}">
                                <div class="category-free-order-row">
                                    ...
                                    <div class="input-group input-group-sm" style="width:130px;">
                                        <input type="number" name="category_free_orders[{{ $cat }}]" class="form-control form-control-custom text-center font-weight-bold" min="0" value="{{ $val }}" placeholder="Orders">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <select name="sender_cashback_type" id="sender_cashback_type" class="form-control form-control-custom" onchange="updateCashbackLabels()">
                                            ...
                                            <option value="flat" {{ old('sender_cashback_type') === 'flat' ? 'selected' : '' }}>Flat ({{ $currency_symbol ?? \App\Helpers\Helper::getCurrencySymbol() }})</option>
                                        </select>
                                    </div>
                                    <div class="col-6">
                                        <label class="small text-muted mb-1" id="sender_cashback_label">Enter Percentage (%)</label>
                                        <input type="number" name="sender_cashback_value" id="sender_cashback_value" class="form-control form-control-custom" min="0" step="0.01" value="{{ old('sender_cashback_value', 2) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <select name="receiver_cashback_type" id="receiver_cashback_type" class="form-control form-control-custom" onchange="updateCashbackLabels()">
                                            ...
                                            <option value="flat" {{ old('receiver_cashback_type') === 'flat' ? 'selected' : '' }}>Flat ({{ $currency_symbol ?? \App\Helpers\Helper::getCurrencySymbol() }})</option>
                                        </select>
                                    </div>
                                    <div class="col-6">
                                        <label class="small text-muted mb-1" id="receiver_cashback_label">Enter Percentage (%)</label>
                                        <input type="number" name="receiver_cashback_value" id="receiver_cashback_value" class="form-control form-control-custom" min="0" step="0.01" value="{{ old('receiver_cashback_value', 2) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6 mb-3">
                            <div class="p-3 bg-light border rounded">
                                ...
                                <input type="number" name="cashback_on_purchase" class="form-control form-control-custom" min="0" step="0.01" value="{{ old('cashback_on_purchase', 0) }}" placeholder="e.g. 100">
                            </div>
                        </div>
                    </div>
                </div>
