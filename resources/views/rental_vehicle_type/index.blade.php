                            ...
                            <table id="example24"
                                ...
                                <tr>
                                    ...
                                    <td> @if ($type->status=="yes")
                                          <label class="switch"><input type="checkbox" id="{{$type->id}}" name="isActive" checked><span class="slider round"></span></label>
                                        @else
                                   ...
                                   {{-- <td>
                                    ...
                                    <td class="action-btn"><a href="{{route('vehicle-rental-type.edit', ['id' => $type->id])}}"><i
                                                    class="fa fa-edit"></i></a><a id="'+val.id+'" href="{{route('vehicle-rental-type.delete', ['id' => $type->id])}}" class="delete-btn"><i
