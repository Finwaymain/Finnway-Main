                        ...
                        <div class="table-responsive m-t-10">
                            ...
                            <table id="example24"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($brand->status=="yes")
                                        <label class="switch"><input type="checkbox" id="{{$brand->id}}" name="isActive"
                                                                     checked><span class="slider round"></span></label>
                                        @else
                                        <label class="switch"><input type="checkbox" id="{{$brand->id}}"
                                                                     name="isActive"><span class="slider round"></span></label>
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td class="action-btn"><a href="{{route('brand.edit', ['id' => $brand->id])}}"><i
                                                    class="fa fa-edit"></i></a>
                                        <a href="{{route('brand.delete', ['id' => $brand->id])}}" class="delete-btn"><i
                                                    class="fa fa-trash"></i></a>
                                        <!--<a href="{{route('brand.show', ['id' => $brand->id])}}" class=""
                                           data-toggle="tooltip" data-original-title="View détails"><i
