		                            	...
		                            	<div class="col-md-12">
		                                    <div class="col-group-btn">
		                                        @if ($discount->statut=="yes")
		                                            <a href="{{route('coupons.changeStatus', ['id' => $discount->id])}}" class="btn btn-success btn-sm edit-form-btn" data-toggle="tooltip" data-original-title="Activate">Enable<i class="fa fa-check"></i> </a>
		                                        @else
		                                        <a href="{{route('coupons.changeStatus', ['id' => $discount->id])}}" class="btn btn-warning btn-sm edit-form-btn" data-toggle="tooltip" data-original-title="Activate"> Disable<i class="fa fa-check"></i> </a>
		                                        @endif
		                                   </div>
		                                </div>
		                             </div>
