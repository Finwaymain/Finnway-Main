                        ...
                        <div class="row">
                            <div class="col-md-6 form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" min="0" max="{{ $rewardMode === 'percentage' ? '100' : '999999' }}" name="reward_value" id="reward_value_input" class="form-control font-weight-bold text-dark" value="{{ $rewardValue }}" placeholder="{{ $rewardMode === 'flat' ? '50' : '1.0' }}" style="color: #0f172a !important;" oninput="validateRewardInput(this)">
...
<script>
    ...
    function validateRewardInput(el) {
        var mode = document.getElementById('mode_input_field').value;
        if (mode === 'percentage') {
    ...
    function updateEventValueSymbol(evtKey, type) {
        ...
        var input = document.getElementById('evt_val_input_' + evtKey);
        ...
        if (type === 'flat') {
            ...
            if (input && parseFloat(input.value) > 100) input.value = 100;
        }
    }
    ...
    $(document).on('input', 'input[id^="evt_val_input_"]', function() {
        var evtKey = this.id.replace('evt_val_input_', '');
        var selectType = $('select[name="event_' + evtKey + '_type"]').val();
