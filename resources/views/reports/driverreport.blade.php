                ...
                <fieldset>
                  <legend>{{trans('lang.driver_reports')}}</legend>
                        ...
                        <div class="form-group row width-50">
                          ...
                          <div class="col-7">
                            <select class="form-control" name="date" id="date" onchange="toggleDriverDateInputs(this.value)">
...
@section('scripts')
<script>
function toggleDriverDateInputs(val) {
...
$(document).ready(function() {
    toggleDriverDateInputs($('#date').val());
});
</script> 
@endsection