...
<div class="page-wrapper">
    <div class="container-fluid pt-3">
        ...
        <div class="page-header-card d-flex align-items-center justify-content-between">
            <div>
                <h3><i class="mdi mdi-pencil-box-outline text-primary mr-2"></i>Edit Consumer Premium Plan</h3>
                <p>Modify consumer subscription rates, cashback, service discounts, and quotas.</p>
            </div>
        ...
        <form action="{{ route('consumer-plans.update', $plan->id) }}" method="POST" id="consumer_plan_form">
            @csrf
            @method('PUT')
                ...
                <div class="section-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <label class="form-label-custom">Price ({{ $currency_symbol ?? \App\Helpers\Helper::getCurrencySymbol() }}/year) <span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <select name="sender_cashback_type" id="sender_cashback_type" class="form-control form-control-custom" onchange="updateCashbackLabels()">
                                            ...
                                            <option value="flat" {{ old('sender_cashback_type', $plan->sender_cashback_type ?? '') === 'flat' ? 'selected' : '' }}>Flat ({{ $currency_symbol ?? \App\Helpers\Helper::getCurrencySymbol() }})</option>
                                        </select>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <select name="receiver_cashback_type" id="receiver_cashback_type" class="form-control form-control-custom" onchange="updateCashbackLabels()">
                                            ...
                                            <option value="flat" {{ old('receiver_cashback_type', $plan->receiver_cashback_type ?? '') === 'flat' ? 'selected' : '' }}>Flat ({{ $currency_symbol ?? \App\Helpers\Helper::getCurrencySymbol() }})</option>
                                        </select>
                                    </div>
                                    <div class="col-6">
                ...
                <div class="section-body p-0">
                        ...
                        <table class="table table-hover table-bordered align-middle mb-0 text-center">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th style="width: 24%;">Max Amount ({{ $currency_symbol ?? \App\Helpers\Helper::getCurrencySymbol() }})</th>
                    ...
                    <div class="p-3 bg-light border-top">
                        ...
                        <div class="border-top pt-3 mt-2">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-2">
                                    <label class="small text-muted mb-1">Virtual Credit Limit ({{ $currency_symbol ?? \App\Helpers\Helper::getCurrencySymbol() }})</label>
                                ...
                                <div class="col-md-4 mb-2">
                                    <label class="small text-muted mb-1">Monthly Bonus ({{ $currency_symbol ?? \App\Helpers\Helper::getCurrencySymbol() }})</label>
                                ...
                                <div class="col-md-4 mb-2">
                                    <label class="small text-muted mb-1">Annual Voucher Value ({{ $currency_symbol ?? \App\Helpers\Helper::getCurrencySymbol() }})</label>
                        ...
                        <div class="border-top pt-3 mt-2">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 mb-2">
                                    <label class="small text-muted mb-1">Max Loan Amount ({{ $currency_symbol ?? \App\Helpers\Helper::getCurrencySymbol() }})</label>
            ...
            <div class="d-flex align-items-center gap-3 mb-5">
                <button type="submit" class="btn btn-primary-custom"><i class="fa fa-save mr-1"></i> Update Consumer Plan</button>
