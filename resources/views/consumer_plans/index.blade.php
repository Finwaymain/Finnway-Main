                            ...
                            <table class="table table-hover table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>₹{{ number_format($plan->price, 2) }}/yr</td>
                                        <td>{{ $plan->validity_days }} days</td>
                                        <td>
                                            <span class="badge badge-success">S: {{ $plan->sender_cashback_value }}{{ $plan->sender_cashback_type === 'percentage' ? '%' : '₹' }}</span>
                                            <span class="badge badge-primary ml-1">R: {{ $plan->receiver_cashback_value }}{{ $plan->receiver_cashback_type === 'percentage' ? '%' : '₹' }}</span>
                                        </td>
                                        <td>
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="8" class="text-center text-muted">No consumer plans yet. <a href="{{ route('consumer-plans.create') }}">Create one.</a></td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
