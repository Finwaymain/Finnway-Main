                                    ...
                                    <div class="form-group">
                                        <form action="{{ route('sos') }}" method="get">
                                            ...
                                            <select name="selected_search" id="selected_search" class="form-control input-sm">
                                                <option value="status" @if ($_GET['selected_search']=='status') selected="selected" @endif>{{trans('lang.status')}}</option>
                        ...
                        <div class="table-responsive m-t-10">
                            ...
                            <table id="example24"
                                ...
                                <tr>
                                    ...
                                    <td class="action-btn">
                                        <a href="{{route('sos.show',['id'=>$so->id])}}" data-toggle="tooltip" data-original-title="Details"><i class="fa fa-eye"></i></a>
                                        <a id="'+val.id+'" class="delete-btn" name="user-delete" href="{{route('sos.delete', ['id' => $so->id])}}"><i class="fa fa-trash"></i></a>
