                            ...
                            <table id="example24" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                ...
                                <tbody id="append_list12">
                                    @foreach($language as $customer)
                                        ...
                                        <td class="action-btn"><a href="{{route('language.edit', ['id' => $customer->id])}}"><i class="fa fa-edit"></i></a><a id="'+val.id+'" class="delete-btn" name="user-delete" href="{{route('language.delete', ['id' => $customer->id])}}"><i class="fa fa-trash"></i></a>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
