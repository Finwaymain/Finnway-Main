                                    ...
                                    <div class="restaurant_payout_create-inner">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" class="form-control"
                                                           value="{{ Request::old('prix') }}" name="prix">
                                                </div>
                                            </div>

                                            <div class="form-group row width-50">
                                                <label class="col-3 control-label">{{trans('lang.base_price')}}</label>
                                                <div class="col-7">
                                                    <input type="number" step="0.01" class="form-control"
                                                           value="{{ Request::old('base_price') }}" name="base_price">
                                                </div>
                                            </div>

                                            <div class="form-group row width-50">
                                                <label class="col-3 control-label">{{trans('lang.per_km_price')}}</label>
                                                <div class="col-7">
                                                    <input type="number" step="0.01" class="form-control"
                                                           value="{{ Request::old('per_km_price') }}" name="per_km_price">
                                                </div>
                                            </div>
