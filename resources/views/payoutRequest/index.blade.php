                                        ...
                                        @foreach($withdrawal as $value)
                                            <tr>
                                                ...
                                                <td ><a  name="driver_view" id={{$value->id_conducteur}} href="javascript:void(0)" data-toggle="modal" data-target="#bankdetailsModal"><i class="fa fa-eye"></i></a>
                                                    <a  name="driver_check" id="{{$value->id}}" href="javascript:void(0)"><i class="fa fa-check edit-form-btn" style="color:green"></i></a>
                                                    <a name="driver_reject" id="{{$value->id}}" href="javascript:void(0)"><i class="fa fa-close edit-form-btn" ></i></a></td>
                                            </tr>
                                        @endforeach
                                        @else
