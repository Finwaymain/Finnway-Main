            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex top-title-section pb-4 justify-content-between">
                        ...
                        <form action="{{ route('dispatcher-users') }}" method="get" id="filterForm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="userlist-topsearch d-flex mb-3">
                            ...
                            <div class="userlist-top-left">
                                ...
                                <a class="nav-link" href="{!! route('dispatcher-users.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.dispatcher_user_create')}}</a>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <form action="{{ route('dispatcher-users') }}" method="get">
                                            ...
                                            <div class="search-box position-relative">
                                                ...
                                                <a class="btn btn-warning btn-flat" href="{{url('dispatcher-users')}}">Clear</a>
                            ...
                            <table id="example24" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                ...
                                <tbody id="append_list12">
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="rounded" style="width:50px" src="{{asset('assets/images/dispatcher_users/' . $customer->profile_picture_path)}}" alt="image"></td>
                                        ...
                                        <td><a href="{{route('dispatcher-users.show', ['id' => $customer->id])}}">{{$customer->first_name}} {{ $customer->last_name}}</a>
                                        ...
                                        <td class="action-btn">
                                            ...
                                            <a href="{{route('dispatcher-users.show', ['id' => $customer->id])}}" class="" data-toggle="tooltip" data-original-title="Details"><i class="fa fa-eye"></i></a>

                                            <a href="{{route('dispatcher-users.edit', ['id' => $customer->id])}}"><i class="fa fa-edit"></i></a><a id="'+val.id+'" class="delete-btn" name="user-delete" href="{{route('dispatcher-users.delete', ['id' => $customer->id])}}"><i class="fa fa-trash"></i></a>
